...
module.exports = {
    async index(request, response) {
        try {
            ...
            response.status(500).json({ error: err.messagr });
        }
    },
    ...
    async update (request, response) {
        ...
        try {
            ...
            return response.status(200).json({ error: "Video updated successfully!" });
        } catch (err) {
    ...
    async delete(request, response) {
        try {
            ...
            return response.status(200).json({ error: "Video deleted successfully!" });
